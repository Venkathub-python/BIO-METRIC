...
message = tk.Label(window, text="Bio-metric Based Attendance Management System" ,bg="yellow"  ,fg="red"  ,width=50  ,height=3,font=('times', 20, 'italic bold underline')) 

message.place(x=270, y=20)
message = tk.Label(window, text="developed by:SIVAMANI" ,bg="yellow"  ,fg="red"  ,width=20  ,height=2,font=('times', 15, 'italic bold underline')) 

message.place(x=850, y=120)

lbl = tk.Label(window, text="Enter ID",width=20  ,height=2  ,fg="red"  ,bg="yellow" ,font=('times', 15, ' bold ') ) 
lbl.place(x=270, y=250)
...
clearButton2.place(x=850, y=350)    
